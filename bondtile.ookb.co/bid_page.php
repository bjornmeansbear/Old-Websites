...
<head>
	<!-- html, css and php by kristian bjørnard - www.kristianbjornard.com -->
	...
	<script type="text/javascript">
		function checkWholeForm(bid_form) {
			var why = "";
			why += checkEmail(bid_form.email.value);
			}
			if (why != "") {
			   alert(why);
			   return false;
...
<!-- ******************************** content ************************************ -->
	 		...
	 		<div id='main'> 
				...
				<div id='request_bid'>
					<div class='text'>
						<p>
							Bond Tile and Stone realizes that every project is unique. Therefore, our bids are based on an on-site visit and free consultation.
						</p>
						<p>
...
<!-- ******************************** footer ************************************ -->
			...
			<div id='footer' class='shadow'>
				<div class='pad'>
		        	<p>&copy; <?php echo date("Y") ?> Bond Tile and Stone LLC. Design: <a href='http://www.zindrendesign.com' class='external'>Zindren Design</a>
					</p>
